          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="glass-panel p-8 rounded-2xl border-cyanic-500/20">
                ...
                <h3 className="font-syne text-xl font-bold text-white mb-2">Pruebas en el Río</h3>
              ...
              <div className="glass-panel p-8 rounded-2xl border-copper-500/20">
                ...
                <h3 className="font-syne text-xl font-bold text-white mb-2">Alianza UACh & THEMS</h3>
                <p className="text-sm text-slate-300 leading-relaxed">
              ...
              <div className="glass-panel p-8 rounded-2xl border-slate-400/20">
                ...
                <h3 className="font-syne text-xl font-bold text-white mb-2">Marco Regulatorio DIRECTEMAR</h3>
                <p className="text-sm text-slate-300 leading-relaxed">
