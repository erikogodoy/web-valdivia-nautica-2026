  ...
  return (
    <section className="py-28 sm:py-36 md:py-44 bg-[#0025b5] text-white relative z-20 shadow-xl">
      <div className="max-w-5xl mx-auto px-6 sm:px-10 lg:px-12 text-left">
        ...
        {/* Headline with Google Font Syne (Wide, Impactful Display Font) */}
        <h2 className="text-3xl sm:text-5xl md:text-6xl font-syne font-bold text-white tracking-tight mb-10 leading-[1.15]">
          El agua no es solo paisaje. <br />
          <span className="text-poster-gold font-bold">Es desarrollo, territorio e identidad.</span>
        </h2>

        {/* Descriptive Paragraph with Standard Site Body Font (Inter) */}
        <p className="text-lg sm:text-2xl text-slate-100 leading-relaxed font-sans font-normal max-w-4xl opacity-95">
